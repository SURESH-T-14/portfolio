...
export const skillGroups = [
  {
    ...
    items: [
      { name: 'Java', mark: 'Ja', color: '#f89820', icon: '/media/skill-icons/icons8-java-48.png' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'REST APIs', mark: 'API', color: '#9ebad8', icon: '/media/skill-icons/icons8-rest-api-48.png' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'JavaScript', mark: 'JS', color: '#f7df1e', icon: '/media/skill-icons/java-script.png' },
      { name: 'TypeScript', mark: 'TS', color: '#3178c6', icon: '/media/skill-icons/icons8-typescript-48.png' }
    ]
  },
  {
    number: '04',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'GitHub', mark: 'GH', color: '#e8e8e8', icon: '/media/skill-icons/icons8-github-logo-94.png' },
